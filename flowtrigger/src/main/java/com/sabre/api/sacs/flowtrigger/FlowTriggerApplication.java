...
public class FlowTriggerApplication {
	...
	public static void main(String[] args) {
		...
		final ApplicationContext ctx = SpringApplication.run(new Object[] { FlowTriggerApplication.class,
				SoapApplicationConfiguration.class, RestApplicationConfiguration.class }, args);
